...
Balsamiq.prototype.setTimeout = function(timeout) {
...
Balsamiq.prototype.render = function(bmml, jpg) {
  ...
  if (self.rendering) {
    ...
    return Q.promise(function(resolve, reject, notify) {
      spawn([self.exe, 'export', path.resolve(tilda(bmml)), path.resolve(tilda(jpg))])
        .timeout(self.timeout, {
          err:'Render took longer than ' + (self.timeout / 1000) + ' seconds.',
          bmml: bmml,
          jpg: jpg
        })
        .then(function() {
